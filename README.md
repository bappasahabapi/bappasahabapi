...
| ---------------------------------------------- | ---------------------------------------------------------------------- | ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Front-End Engineer & ICT Instructor**        | [বন্দি পাঠশালা](https://www.bondipathshala.education/bn)               | *Aug,2020 – Mar,2022*           | - Built a university management prototype using the **MERN** stack<br>                                  |
...
| **Frontend & Backend Developer** | [Arab Interface Technology](https://arabinterfacetech.com/about-us/)   | *Contractual-3 month*           | - Worked on frontend and backend development using **React, Redux, Node.js, Express, PostgreSQL**<br>- Developed features and maintained the application for clients  |
| **Software Engineer: Mid**                     | [Blue Flower Media](https://blueflowermedia.com)                       | *Dec,2024 – Present*            | - Develop software solutions for USA clients<br>- Collaborate with cross-functional teams to deliver robust, scalable applications                                           |
