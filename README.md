...
| ---------------------------------------------- | ---------------------------------------------------------------------- | ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Software Engineer **(Backend-Focused)**        | [Dropndot](https://www.dropndot.com/)                                  | *Nov,2025 – Present*            | - Building robust backend systems and APIs for US-based clients<br>- Focused on scalability, performance, and clean architecture                                      |
| ✅ Selected Candidate for Software Engineer post**(Did Not Join)** | [Betafore](https://betafore.com/)                                      | *2025, Interview cleared, not joined* | - Successfully cleared 4 rounds: English test, Stack-related round, Technical round & problem solving, Technical discussion<br>- Did not join due to personal reasons |
| Software Engineer: **Mid**                     | [Blue Flower Media](https://blueflowermedia.com)                       | *Dec,2024 – Oct,2025*           | - Developed software solutions for foreign clients<br>- Collaborated with cross-functional teams to deliver robust, scalable applications                                |
| Full Stack Developer            | [Arab Interface Technology](https://arabinterfacetech.com/about-us/)   | *Contractual-3 month*           | - Worked on frontend and backend development using **React, Redux, Node.js, Express, PostgreSQL**<br>- Developed features and maintained the application for clients  |
...
| Front-End Engineer & Mentor        | [বন্দি পাঠশালা](https://www.bondipathshala.education/bn)               | *Aug,2020 – Mar,2022*           | - Built a university management prototype using the **MERN** stack                                                             |
